...
class ha_rocksdb : public my_core::handler {
  ...
  */
  ...
  void update_auto_incr_val(bool use_datadic, longlong target_value = 0);
  rocksdb::Status data_dictionary_autoincrement(Rdb_transaction *const tx,
                                                const GL_INDEX_ID &gl_index_id,
                                                longlong *new_val) const;
  bool merge_auto_increment(int curr_id);
